...
def calculate_output_power(input_power, gain, cable_loss, attenuation):
    return input_power + gain - cable_loss - attenuation

output_power = calculate_output_power (input_power,amplifier_gain,cable_loss,attenuation)
